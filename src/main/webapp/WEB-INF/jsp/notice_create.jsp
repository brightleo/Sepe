...
<%@ include file="common/header.jsp" %>
    <form id="notice_create_form" class="form-horizontal">
        <div class="css-form-header">
            <h6><f:message key="notice.create_notice"/></h6>
        </div>
        ...
        <div class="form-group">
            ...
            <div>
                <input type="text" id="noticeDate" name="noticeDate" class="ext-required css-readonly" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div>
                <label class="radio" for="type1">
                    <tag:types index="1" value="1" /><f:message key="notice.type.1"/>
                </label>
                <label class="radio" for="type2">
                    <tag:types index="2" value="1" /><f:message key="notice.type.2"/>
                </label>
                <label class="radio" for="type3">
                    <tag:types index="3" value="1" /><f:message key="notice.type.3"/>
                </label>
                <label class="radio" for="type4">
                    <tag:types index="4" value="1" /><f:message key="notice.type.4"/>
                </label>
            </div>
        </div>
        <div class="form-group">
